...
public class AdminIntegralGradeController {
    ...
    public R listAll() {
        ...
        List<IntegralGrade> list = integralGradeService.list();//  通用Service
        return R.ok().data("list", list).message("获取列表成功");
    }

    @ApiOperation(value = "根据id删除数据记录", notes = "逻辑删除逻辑记录")
